...
var RuntimeDataClient = class _RuntimeDataClient {
  ...
  async _executeRequest(config, context) {
    ...
    const requestBody = config.body ? config.headers?.["Content-Type"] === "application/octet-stream" ? new Blob([config.body], { type: "application/octet-stream" }) : new Blob([config.body], { type: "application/json" }) : "";
    let result;
    try {
